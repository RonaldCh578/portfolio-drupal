...
class __TwigTemplate_62cc069edc9d3167dd5d8db64c4002f5a0b897b67cd41d262fe82797122fc390 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["menu_level"] ?? null) == 1) && twig_get_attribute($this->env, $this->source, $context["item"], "is_expanded", [], "any", false, false, true, 47))) {
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/dxpr_theme/templates/menu--main.html.twig", "/app/themes/contrib/dxpr_theme/templates/menu--main.html.twig");
    }
